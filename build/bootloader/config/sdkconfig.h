...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions/4m.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions/4m.csv"
...
#define CONFIG_ESP_SYSTEM_EVENT_TASK_STACK_SIZE 10000
